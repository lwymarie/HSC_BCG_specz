...
co-moving distance of $\approx120\,h^{-1}\,{\rm Mpc}$ at $z=0.5$. This is much larger than the typical size of a dark
matter halo, so photometric redshifts are prone to projection effects, Photometric redshifts are insufficient for
distinguishing between galaxies in the same halo versus those in more distance halos. On the other hand, redshift
precision is limited by the finger-of-god effect. The typical halos of our study have velocity dispersions
$\sigma(v)\approx600\,{\rm km\,s^{-1}}$, which corresponds to a minimum resolvable distance that sets our desired
redshift precision.
